...
$conn = mysqli_connect('localhost', 'root', 'JIUbugaosuni', 'OldDeal');
$sql  = "set names utf8";
mysqli_query($conn, $sql);
//sql2 获取总记录数 计算总页数
$sql                  = "select count(*)from olddeal_user where memberLevel =0";
...
$sql           = "select *from olddeal_user where memberLevel =0 limit $start,$count";
$result        = mysqli_query($conn, $sql);
