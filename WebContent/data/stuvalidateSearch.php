...
//sql2 获取总记录数 计算总页数
$sql="select count(*) from stuvalidate where stuSchool LIKE '%$kw%' OR stuCollege LIKE '%$kw%' OR stuNumber LIKE '%$kw%' OR stuName LIKE '%$kw%'";
...
$sql="select *from stuvalidate where stuSchool LIKE '%$kw%' OR stuCollege LIKE '%$kw%' OR stuNumber LIKE '%$kw%' OR stuName LIKE '%$kw%' limit $start,$count";
$result=mysqli_query($conn,$sql);
