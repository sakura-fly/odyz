...
//sql2 获取总记录数 计算总页数
$sql="select count(*) from olddeal_user where uname LIKE '%$kw%' AND memberLevel =0";
...
$sql="select *from olddeal_user where uname LIKE '%$kw%' AND memberLevel =0 limit $start,$count";
$result=mysqli_query($conn,$sql);
